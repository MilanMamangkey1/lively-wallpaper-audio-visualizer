...
function setBackgroundBlur(isPlaying) {
  const filterValue = isPlaying ? "blur(15px) brightness(80%)" : "none";
  backgroundImage.style.filter = filterValue;
  backgroundImageFade.style.filter = filterValue;
}
...
let defaultBackground = "res/background.jpg",
  defaultAlbumArt = "res/record.jpg";
...
function livelyCurrentTrack(data) {
  ...
  if (obj != null) {
    ...
    document.querySelector("h1").innerText = "Hello, Kylan!";
    document.getElementById("albumart").src = defaultAlbumArt;
    $("#backgroundImageFade").css("opacity", 1.0);
    backgroundImageFade.src = backgroundImage.src;
    backgroundImage.src = defaultBackground;
